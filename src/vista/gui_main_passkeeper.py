...
class PassKeeperApp(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.title_label.setStyleSheet("color: #2C3E50; font-size: 24px; font-weight: bold; color: black;")
        ...
        self.service_input.setStyleSheet("background-color: white; border: 1px solid #BDC3C7; border-radius: 5px; color: black;")

        self.username_input = QtWidgets.QLineEdit(self)
        self.username_input.setGeometry(300, 380, 200, 30)
        self.username_input.setPlaceholderText("Usuario")
        self.username_input.setStyleSheet("background-color: white; border: 1px solid #BDC3C7; border-radius: 5px; color: black;")

        self.password_input = QtWidgets.QLineEdit(self)
        self.password_input.setGeometry(550, 380, 200, 30)
        self.password_input.setPlaceholderText("Contraseña")
        self.password_input.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.password_input.setStyleSheet("background-color: white; border: 1px solid #BDC3C7; border-radius: 5px; color: black;")
